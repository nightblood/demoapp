			...
			if (!xmppManager.isRegistered()) {
				...
				PacketListener packetListener = new PacketListener() {
					...
					public void processPacket(Packet packet) {
						Log.d(LOGTAG, "RegisterTask.PacketListener " + "processPacket().....");
						Log.d(LOGTAG , "RegisterTask.PacketListener " + "packet=" + packet.toXML());
	...
	private class LoginTask implements Runnable {
		...
		public void run() {
			...
			if (!xmppManager.isAuthenticated()) {
				...
				try {
					connection.login(xmppManager.getUsername(), xmppManager.getPassword(), XMPP_RESOURCE_NAME);
