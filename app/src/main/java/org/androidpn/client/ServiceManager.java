...
import org.androidpn.demoapp.utils.MyUtils;
...
public final class ServiceManager {
    ...
    public ServiceManager(Context context) {
        ...
        //192.168.1.103
        xmppHost = props.getProperty("xmppHost", "192.168.1.103");
    ...
    public void startService() {
        Thread serviceThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                context.startService(MyUtils.createExplicitFromImplicitIntent(context, intent));
            }
        });
        serviceThread.start();
    }
